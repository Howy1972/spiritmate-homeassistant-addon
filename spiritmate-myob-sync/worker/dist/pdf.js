...
exports.parsePdfInvoice = parsePdfInvoice;
 ...
 */
function parseMultiProductLine(line) {
    const items = [];
    try {
 ...
 */
function parseDescriptionsFromConcatenated(concatenated, numProducts) {
 ...
 */
function parseSingleProductLine(line) {
    try {
 ...
 */
async function parsePdfInvoice(pdfBuffer) {
    try {
